...
Case of 
	...
	: (Form event code:C388=On Load:K2:1)
		...
		Form:C1466.linkTitles:=False:C215
		Form:C1466.linkImages:=False:C215
		Form:C1466.keepWithNext:=False:C215
		
		
		//$o:=Get action info("visibleHiddenChars")
		//OBJECT SET TITLE(*; "cbvisibleHiddenChars"; $o.title)
